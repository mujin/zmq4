...
type Transport interface {
	...
	Listen(ctx context.Context, addr string, listenFunction func(string, string) (net.Listener, error)) (net.Listener, error)
...
// Listen announces on the provided network address.
func (trans netTransport) Listen(ctx context.Context, addr string, listenFunction func(string, string) (net.Listener, error)) (net.Listener, error) {
	if listenFunction != nil {
		return listenFunction(trans.prot, addr)
	}
